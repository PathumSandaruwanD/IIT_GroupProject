            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-4 col-md-3 item-srv">
                        ...
                        <div><Link to="/Home" class="nav-link active">Home</Link></div>
                        <div><Link to="/AboutUs" class="nav-link ">About Us</Link></div>
                        <div><Link to="/Services" class="nav-link ">Services</Link></div>
                        <div><Link to="/Gallery" class="nav-link ">Gallery</Link></div>

                        <div><Link to="/Registation" class="nav-link ">Registation</Link></div>
                        <div><Link to="/Login" class="nav-link ">Login</Link></div>
                        <div><Link to="/Contact" class="nav-link">Contact Us</Link></div>
                        <div><Link to="/MonthlyPayment" class="nav-link">Payments</Link></div>
